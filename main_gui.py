...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.le_mfr, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.l_cam_id, 0, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.cb_smp, 10, 0, 1, 2)
        self.cb_see = QtWidgets.QCheckBox(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(10)
        self.cb_see.setFont(font)
        self.cb_see.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.cb_see.setChecked(True)
        self.cb_see.setObjectName("cb_see")
        self.gridLayout.addWidget(self.cb_see, 17, 0, 1, 3)
        self.le_cam_id = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        self.le_cam_id.setFont(font)
        self.le_cam_id.setObjectName("le_cam_id")
        self.gridLayout.addWidget(self.le_cam_id, 0, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.cb_all_mns, 17, 5, 1, 4)
        ...
        self.gridLayout.addWidget(self.l_st, 14, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.l_grd, 9, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.cb_cam, 1, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.l_monitor, 18, 3, 2, 9)
        ...
        self.gridLayout.addWidget(self.cb_mdl, 11, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.cb_tst, 10, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.l_dft, 14, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.l_dsc, 5, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.cb_clb, 2, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.cb_gf, 12, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.le_name, 3, 1, 1, 8)
        ...
        self.gridLayout.addWidget(self.b_stop, 19, 0, 1, 3)
...
"\n"
""))
        self.le_dft.setText(_translate("MainWindow", "0.2"))
    ...
    def do(self):
        ...
        self.cb_see.clicked.connect(self.see_data_uncheck)
        self.cb_gf.clicked.connect(self.fix_uncheck)
        self.cb_smp.clicked.connect(self.smp_uncheck)
        self.cb_tst.clicked.connect(self.tst_uncheck)
    ...
    def b_start_action(self):
        ...
        self.mfr = float(self.le_mfr.text())
        ...
        if self.cb_gf.checkState() == 2:
            self.worker.gf = True
        if self.cb_see.checkState() == 2:
            self.worker.see = True
        ...
        self.worker.see_started.connect(lambda: self.monitor("Seeing pixels"))
