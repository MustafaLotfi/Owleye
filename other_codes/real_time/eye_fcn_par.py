...
def get_calibration_win():
    ...
    n_sample = n_calibration_points * tp.N_SAMPLE_PER_POINT
    red_point_locations = np.zeros((n_sample, 2))
...
def get_model_inputs(
    ...
    if mfl:
        ...
        eyes_frame_gray = cv2.cvtColor(eyes_frame_rgb, cv2.COLOR_RGB2GRAY)
